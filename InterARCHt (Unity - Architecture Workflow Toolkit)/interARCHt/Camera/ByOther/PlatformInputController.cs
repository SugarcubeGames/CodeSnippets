...
namespace interARCHt.Camera
{
	...
	public class PlatformInputController : MonoBehaviour
	{
		...
		void Update()
		{
			...
			directionVector = UnityEngine.Camera.main.transform.rotation * directionVector;

			// Rotate input vector to be perpendicular to character's up vector
			Quaternion camToCharacterSpace = Quaternion.FromToRotation(-UnityEngine.Camera.main.transform.forward, transform.up);
